...
def test_decode():
    ...
    assert decode(b'\xFE\xFF\xe9\x00', 'ascii') == ('\ue1800', lookup('utf-16be'))
    assert decode(b'\xFF\xFE\x00\xe9', 'ascii') == ('\ue1800', lookup('utf-16le'))
    ...
    assert decode(b'\xe9\x00', 'UTF-16BE') == ('\ue1800', lookup('utf-16be'))
    assert decode(b'\x00\xe9', 'UTF-16LE') == ('\ue1800', lookup('utf-16le'))
    assert decode(b'\x00\xe9', 'UTF-16') == ('\ue1800', lookup('utf-16le'))
